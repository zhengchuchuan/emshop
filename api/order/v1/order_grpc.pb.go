...
func (c *orderClient) CreateOrderCom(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/Order/CreateOrderCom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) SubmitOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/Order/SubmitOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Order_CreateOrderCom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/CreateOrderCom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
